                  ...
                  <div>
                    ...
                    <div className="form-group-custom">
                      ...
                      <select value={newField} onChange={(e) => setNewField(e.target.value)} className="custom-select-box">
                        <option value="Юридические науки (Общее право)">⚖️ Юридические науки (Общее право)</option>
                        <option value="Гражданское и семейное право">📜 Гражданское и семейное право</option>
                        <option value="Уголовное право и криминология">🏛️ Уголовное право и криминология</option>
                        <option value="Конституционное и административное право">🛡️ Конституционное и административное право</option>
                        <option value="Международное право и права человека">🌐 Международное право и права человека</option>
                        <option value="Цифровое право и право ИИ (AI & Digital Law)">🤖 Цифровое право и право ИИ (AI & Digital Law)</option>
                        <option value="Предпринимательское и коммерческое право">💼 Предпринимательское и коммерческое право</option>
                        <option value="Трудовое право и право социального обеспечения">👔 Трудовое право и право социального обеспечения</option>
                        <option value="Экологическое и земельное право">🌱 Экологическое и земельное право</option>
                        <option value="Финансовое и налоговое право">💰 Финансовое и налоговое право</option>
                        <option value="Судебная власть, прокурорский надзор и адвокатура">👨‍⚖️ Судебная власть, прокурорский надзор и адвокатура</option>
                        <option value="Международное частное право">🌍 Международное частное право</option>
                        <option value="Экономические науки и правовой аудит">📊 Экономические науки и правовой аудит</option>
                        <option value="Финансы и Банковское право">🏦 Финансы и Банковское право</option>
                      </select>
                    </div>
